...
st <- s |> 
  filter(NAME == str_to_title(str_replace_all("oklahoma", "_", " ")))
...
texture <- grDevices::colorRampPalette(colors, bias = 6)(256)
...
render_camera(phi = 45, zoom = .9, theta = -5)
...

{
  ...
  render_highquality(
    ...
    lightcolor = c(c1[4], "white", c1[10], "white"),
