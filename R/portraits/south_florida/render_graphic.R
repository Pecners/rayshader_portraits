...
fl_counties <- counties(state = "florida")

these_counties <- fl_counties |> 
...
st_d <- st_join(data, these_counties, left = FALSE)
...
render_camera(phi = 35, zoom = 1, theta = 80)
...

{
  ...
  render_highquality(
    ...
    preview = FALSE,
    light = TRUE,
    lightdirection = rev(c(60, 60, 65, 65)),
