...
# limit kontur data to state

st_d <- st_intersection(data, st)
st_dd <- st_transform(st_d, crs = 2264)
# set up dimensions to convert to raster
...
render_camera(phi = 60, zoom = .9, theta = 15)
...

{
  ...
  render_highquality(
    ...
    light = TRUE,
    lightdirection = 160,
    lightcolor = c("white", colors[1]),
    lightintensity = c(400, 200),
    lightaltitude = c(10, 80),
