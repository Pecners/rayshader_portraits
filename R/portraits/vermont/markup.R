...
img |> 
  ...
  image_crop(geometry = "9500x7600+500+0", gravity = "center") |> 
...
system(
  glue("convert -size 9500x7600 xc:none -gravity west ",
       ...
       "images/vermont/titled_vt_pop.png +swap ",
       "-gravity south -geometry +3500-1250 ",
...
system(
  glue("convert -size 9500x7600 xc:none -gravity west ",
       ...
       # "-gravity north -annotate +0+1000 'Population' ", 
       # "-gravity northeast -kerning 200 -annotate +500+200 'Density' ",
       "images/vermont/titled_vt_pop_one.png +swap ",
       "-gravity south -geometry +3500-1250 ",
