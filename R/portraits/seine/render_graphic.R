...
data <- st_read("data/kontur/kontur_population_FR_20220630.gpkg")
...
seine_buff <- st_transform(seine, crs = st_crs(data)) |> 
  st_buffer(25000)
...
int <- st_intersects(seine_buff, data)
...
render_camera(phi = 60, zoom = .75, theta = 0)
