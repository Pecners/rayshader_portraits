...
# This will be useful if creating an inset map
...
# texture <- grDevices::colorRampPalette(c(colors[4:1], colors[9:5]), bias = 2)(256)
texture <- grDevices::colorRampPalette(colors[c(9:5)], bias = .5)(256)
...
shadow_depth <- min(mat, na.rm = TRUE) - .5
...

{
  ...
  render_highquality(
    ...
    preview = FALSE,
    light = TRUE,
    lightdirection = rev(c(95, 95, 100, 100)),
    lightcolor = c(colors[9], "white", colors[1], "white"),
    ...
    lightintensity = c(750, 75, 500, 75),
