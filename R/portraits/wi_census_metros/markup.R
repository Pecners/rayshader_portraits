...
header <- readRDS("R/portraits/wi_census_metros/header.rds")
...
img |> 
  ...
  image_annotate(text = glue("{str_to_title('wi_census_metros')} Population Density"), 
                 gravity = "northwest",
  ...
  image_annotate(text = "Graphic: Spencer Schien (@MrPecners)", gravity = "southwest",
                 ...
                 color = alpha(text_color, .5),
                 size = 80, weight = 700) |>
  image_write("images/wi_census_metros/titled_STATE_pop.png")

image_read("images/wi_census_metros/titled_STATE_pop.png") |> 
