...
st <- s |> 
  filter(str_detect(NAME, glue("{p[1]}|{p[2]}")))
...
st_d <- shift(st_dd, movement = .85, movement_y = -30)
...

{
  ...
  render_highquality(
    ...
    lightcolor = c(colors[2], "white", colors[5], "white"),
