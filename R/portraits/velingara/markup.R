...
header <- readRDS("R/portraits/velingara/header.rds")
...
add_main_annotations(map = header$map, pal = header$pal, 
                     ...
                     align = "right",
                     base_coords = c(1 - .025, .1),
                     offset = 250,
                     main_text = "Crater of Vélingara",
                     main_size = 200,
                     main_font = "Tapestry",
                     secondary_text = "",
                     secondary_size = 250,
                     ...
                     caption_coords = c(1 - .98, .95),
                     caption_align = "left",
                     twitter_icon_coords = c(-1415, 80),
