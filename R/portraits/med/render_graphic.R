...
# data source: https://www.eea.europa.eu/data-and-maps/data/msfd-regions-and-subregions-3

med_sea <- st_read("data/MSFD_Regions_and_Subregions.gpkg")
...

{
  ...
  render_highquality(
    ...
    light = TRUE,
    # lightdirection = rev(c(40, 40, 45, 45)),
    lightdirection = rev(c(220, 220, 225, 225)),
