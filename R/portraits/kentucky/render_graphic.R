...
st <- s |> 
  filter(NAME == str_to_title(str_replace_all("kentucky", "_", " ")))
...
render_camera(phi = 35, zoom = .85, theta = 0)
...

{
  ...
  render_highquality(
    ...
    preview = FALSE,
    light = TRUE,
    lightdirection = rev(c(210, 210, 220, 220)),
    lightcolor = c(colors[1], "white", colors[6], "white"),
    lightintensity = c(750, 75, 1000, 75),
