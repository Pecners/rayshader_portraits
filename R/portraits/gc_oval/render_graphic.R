...
coords <- c(36.101978, -112.097152)

data <- make_ellipse(coords, r = 80000, height_factor = 1.5, width_factor = .5, 
                     npc = 360, tilt = 10, crs = 2223) 
# Plot to review
data |>
  ggplot() +
  geom_sf()
...
render_camera(phi = 30, zoom = .5, theta = 80)
