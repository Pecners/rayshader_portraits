...
colors <- scico(palette = pal, n = 10,
                direction = 1) 
swatchplot(colors)

texture <- grDevices::colorRampPalette(colors[-c(1:2)], bias = 2)(256)
swatchplot(texture)
...
render_camera(phi = 45, zoom = .9, theta = -20)
...

{
  ...
  render_highquality(
    ...
    lightintensity = c(1000, 50, 600, 50),
