...
header <- readRDS("R/portraits/ny_again/header_nohud.rds")
...
img |> 
  ...
  #                size = 40, weight = 700) |> 
image_write("images/ny_again/titled_ny_again_pop_nohud.png")
...
system(
  glue("convert -size 7000x6200 xc:none -gravity north ",
       ...
       "images/ny_again/titled_ny_again_pop_nohud.png +swap ",
       "-composite images/ny_again/titled_ny_again_pop_nohud_done.png")
)
...
system(
  glue("convert -size 9500x6333 xc:none -gravity south ",
       ...
       # "-gravity north -annotate +0+1000 'Population' ", 
       # "-gravity northeast -kerning 200 -annotate +500+200 'Density' ",
       "images/ny_again/titled_ny_again_pop_nohud_done.png +swap ",
       "-composite images/ny_again/titled_ny_again_pop_nohud_done_cap.png")
)


image_read("images/ny_again/titled_ny_again_pop_nohud_done_cap.png") |> 
  image_scale(geometry = "50%x") |> 
  image_write("tracked_graphics/titled_ny_again_pop_nohud_small.png")
