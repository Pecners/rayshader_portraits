...
st <- s |> 
  filter(NAME == str_to_title(str_replace_all("arkansas", "_", " ")))
...
texture <- grDevices::colorRampPalette(c3, bias = .5)(256)
...

{
  ...
  render_highquality(
    ...
    lightcolor = c(c3[1], "white", c3[5], "white"),
