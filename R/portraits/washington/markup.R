...
header <- readRDS("R/portraits/washington/header.rds")
...
annot <- glue("This map shows population density of Washington. ",
...
img |> 
  ...
  image_annotate(text = "Washington Population Density", gravity = "northwest",
  ...
  image_annotate(text = "Graphic: Spencer Schien (@MrPecners)", gravity = "southwest",
                 ...
                 color = alpha(text_color, .5),
                 size = 80, weight = 700) |>
  image_write("images/washington/titled_wa_pop.png")

image_read("images/washington/titled_wa_pop.png") |> 
  image_scale(geometry = "60%x") |> 
  image_write("tracked_graphics/titled_wa_pop_small.png")
