...
data <- st_read("data/kontur/kontur_population_GB_20220630.gpkg")
...
# create buffer along river

thames_buff <- st_transform(thames, crs = st_crs(data)) |> 
  st_buffer(25000)
...
int <- st_intersects(thames_buff, data)
...
render_camera(phi = 60, zoom = .9, theta = 0)
