...
img |> 
  ...
  image_annotate(text = glue("{str_to_title('montana')} Population Density"), 
                 gravity = "northwest",
  ...
  image_annotate(text = "Graphic: Spencer Schien (@MrPecners)", gravity = "southwest",
                 ...
                 color = alpha(text_color, .5),
                 size = 80, weight = 700) |>
  image_write("images/montana/titled_STATE_pop.png")

image_read("images/montana/titled_STATE_pop.png") |> 
